...
export type Product = { slug: string; name: string; collection: CollectionSlug; palettes: PaletteId[]; basePriceCents: number; description: string; tags: string[]; featured?: boolean } & PosterSpec
